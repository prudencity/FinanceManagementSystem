...
public class MainScreen extends JFrame {
	...
	public MainScreen() {
		...
		JMenuItem mntmPenaltyReceived = new JMenuItem("Penalty Received");
		mnTransaction.add(mntmPenaltyReceived);

		JMenuItem mntmPenaltyCharged = new JMenuItem("Penalty Charged");
		mnTransaction.add(mntmPenaltyCharged);
