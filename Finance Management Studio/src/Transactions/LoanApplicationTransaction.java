...
public class LoanApplicationTransaction extends JFrame {
	...
	public void setCustomerDetails(ResultSet res) throws SQLException {
		customerid_la_text.setText(res.getString("CustomerId"));
	...
	public LoanApplicationTransaction() {
		...
		JButton btn_Autofill = new JButton("AutoFill");
		btn_Autofill.setBounds(322, 71, 84, 20);
		panel_4.add(btn_Autofill);
		btn_Autofill.addActionListener(new ActionListener() {
		...
		JCheckBox chckbxDrivingLicense = new JCheckBox("Driving License");
		chckbxDrivingLicense.setBounds(6, 72, 122, 23);
		panel.add(chckbxDrivingLicense);

		JCheckBox chckbxItr = new JCheckBox("ITR");
		chckbxItr.setBounds(6, 150, 97, 23);
		panel.add(chckbxItr);

		JCheckBox chckbxRationCard = new JCheckBox("Ration Card");
		chckbxRationCard.setBounds(146, 98, 95, 23);
		panel.add(chckbxRationCard);

		JCheckBox chckbxElecBill = new JCheckBox("Electricity Bill");
		chckbxElecBill.setBounds(6, 98, 122, 23);
		panel.add(chckbxElecBill);

		JCheckBox chckbxHomeRegistry = new JCheckBox("Home Registry");
		chckbxHomeRegistry.setBounds(6, 124, 122, 23);
		panel.add(chckbxHomeRegistry);

		JCheckBox chckbxRentAgreement = new JCheckBox("Rent Agreement");
		chckbxRentAgreement.setBounds(146, 124, 128, 23);
		panel.add(chckbxRentAgreement);

		JCheckBox chckbxCreditCard = new JCheckBox("Credit Card");
		chckbxCreditCard.setBounds(6, 46, 97, 23);
		panel.add(chckbxCreditCard);

		JCheckBox chckbxPancard = new JCheckBox("Pancard");
		chckbxPancard.setBounds(146, 46, 97, 23);
		panel.add(chckbxPancard);

		JCheckBox chckbxPassport = new JCheckBox("Passport");
		chckbxPassport.setBounds(146, 72, 97, 23);
		panel.add(chckbxPassport);

		JCheckBox chckbxSalarySlip = new JCheckBox("Salary Slip");
		chckbxSalarySlip.setBounds(146, 150, 97, 23);
		panel.add(chckbxSalarySlip);

		JCheckBox chckbxMarksheet = new JCheckBox("Marksheet");
		chckbxMarksheet.setBounds(146, 16, 97, 23);
		panel.add(chckbxMarksheet);

		JCheckBox chckbxBankPassbook = new JCheckBox("Bank Passbook");
		chckbxBankPassbook.setBounds(6, 17, 122, 23);
		panel.add(chckbxBankPassbook);

		JCheckBox chckbxWaterBill = new JCheckBox("Water Bill");
		chckbxWaterBill.setBounds(276, 150, 129, 23);
		panel.add(chckbxWaterBill);

		JCheckBox chckbxVoterIdCard = new JCheckBox("Voter ID Card");
		chckbxVoterIdCard.setBounds(276, 124, 129, 23);
		panel.add(chckbxVoterIdCard);

		JCheckBox chckbxUid = new JCheckBox("UID");
		chckbxUid.setBounds(276, 98, 129, 23);
		panel.add(chckbxUid);

		JCheckBox chckbxTelephoneBil = new JCheckBox("Telephone Bill");
		chckbxTelephoneBil.setBounds(276, 72, 129, 23);
		panel.add(chckbxTelephoneBil);

		JCheckBox chckbxSocietyPatta = new JCheckBox("Society Patta");
		chckbxSocietyPatta.setBounds(276, 46, 129, 23);
		panel.add(chckbxSocietyPatta);

		JCheckBox chckbxShopRegistry = new JCheckBox("Shop Registry");
		chckbxShopRegistry.setBounds(276, 17, 129, 23);
		panel.add(chckbxShopRegistry);
	}
